...
namespace BlazorTest.Pages
{
    ...
    public class Zodiac : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        protected override void BuildRenderTree(Microsoft.AspNetCore.Components.RenderTree.RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(5, "style", "background-color:lightyellow;display:" + (DisplayType));
...
#line 13 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
...
#line default
#line hidden
#line 15 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
...
#line 18 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
...
#line default
#line hidden
#line 20 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                                 if (i == 0)
                                {
...
#line 23 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                                }
                                else
                                {
...
#line 27 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                                }
...
#line 31 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                             for (int i = 0; i < @zodiacTypesList.Where(x => x.Gender == @u.Gender).Count(); i++)
                            {
...
#line hidden
            ...
            builder.AddContent(34, zodiacTypesList.Where(x => x.Gender == @u.Gender).Skip(i).Take(1).FirstOrDefault().TropicalZodiac.Trim());
            builder.CloseElement();
            builder.CloseElement();
            builder.AddMarkupContent(35, "\r\n");
#line 34 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                            }
...
#line 37 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                             for (int i = 0; i < @zodiacTypesList.Where(x => x.Gender == @u.Gender).Count(); i++)
                            {
...
#line hidden
            ...
            builder.AddContent(42, zodiacTypesList.Where(x => x.Gender == @u.Gender).Skip(i).Take(1).FirstOrDefault().ZodiacTypeTotalCount.ToString("#,##0"));
            builder.CloseElement();
            builder.AddMarkupContent(43, "\r\n");
#line 40 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                            }
...
#line 42 "C:\Develop\GitHub\BlazorTest\Pages\Zodiac.razor"
                    }
